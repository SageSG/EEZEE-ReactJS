...
function resizeProductsBox(){
    setProductsWidth((document.getElementById("Products").offsetWidth-41)/6)
}
    ...
    <main className="flex flex-col flex-wrap w-full h-full px-[120px] pb-[119px] bg-[#EFEFF0] items-center">
      ...
      <section id="featurebrands" className="w-full mt-[40px]">
        ...
        <div className="flex flex-row justify-between">
          ...
          <span className="flex font-roboto font-normal text-[#2A64DB] text-[14px] leading-[22px]" onClick={()=>navigate('brands')}>
            View More{" "}
      ...
      <section id="ourproducts" className="w-full mt-[40px]">
        ...
        <div className="flex flex-row justify-between">
          ...
          <span className="flex font-roboto font-normal text-[#2A64DB] text-[14px] leading-[22px]" onClick={()=>navigate('products')}>
            View More{" "}
            <MdArrowForwardIos className="self-center w-[14px] h-[14px] ml-[4px] text-[#2A64DB] leading-[28px]" />
          </span>
        </div>
        <div id="Products" className="flex flex-row flex-wrap w-full mt-[12px] gap-[8px]">
            ...
            return (
                ...
                />
                {product.vipPriceFlag && <div className="flex h-fit w-fit bg-[#DBE5FA] px-[4px] rounded-sm"><span className="font-roboto font-bold text-[12px] leading-[20px] text-[#1E4DAF]">VIP Price</span></div>}
                {product.bulkDiscountFlag && <div className="flex h-fit w-fit bg-[#FFE69C] px-[4px] rounded-sm"><span className="font-roboto font-bold text-[12px] leading-[20px] text-[#6A5001]">Bulk Discount</span></div>}
                {(product.vipPriceFlag || product.bulkDiscountFlag) && <div className="flex h-fit w-fit bg-[#EFEFF0] px-[4px] rounded-sm"><span className="font-roboto font-bold text-[12px] leading-[20px] text-[#242528]">MOQ: {product.moq}</span></div>}
                </div>
                ...
                <div className="flex flex-col flex-nowrap w-full h-[140px] mt-[8px]">
                  {product.highPriceOriginal && <div className="text-[12px] leading-[20px] text-[#868A92] font-roboto font-normal line-through">
